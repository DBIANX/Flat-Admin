<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevoMensaje.aspx.cs" Inherits="gaudiAdm.NuevoMensaje" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="tablaMensajes">
                <tr>
                    <td>
                        <asp:Label ID="lblTitulo" runat="server" CssClass="lblTitulo" Text="Redactar respuesta"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp; &nbsp;</td>
