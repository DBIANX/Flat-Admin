                            ...
                            <table class="auto-style1">
                                <tr>
                                    <td class="auto-style2" colspan="2">
                                        ...
                                        <asp:Panel ID="pnlCondominiosListado" runat="server">
                                            <asp:Button ID="btnAgregarCondominio" runat="server" OnClick="btnAgregarCondominio_Click" Text="Crear condominio" Width="171px" />
                                            <br />
                                            <br />
                                            <asp:GridView ID="grvCondominiosListado" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="5" CssClass="gridview" DataKeyNames="idCond" HorizontalAlign="Center" OnDataBound="GridView1_DataBound" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="100%">
                                                <Columns>
                                        ...
                                        <asp:Panel ID="pnlCondominiosAgregar" runat="server" Visible="False">
                                            <table class="auto-style1">
                                                <tr>
                                                    <td class="auto-style17" colspan="2">
                                                        <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="Large" Text="Crear nuevo condominio"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="auto-style20">Código</td>
                                                    <td>
                                                        <asp:TextBox ID="txtCrearCondominioCodigo" runat="server" MaxLength="3"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style20">Nombre</td>
                                                    <td>
                                                        <asp:TextBox ID="txtCrearCondominioNombre" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style20">Dirección</td>
                                                    <td>
                                                        <asp:TextBox ID="txtCrearCondominioDireccion" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style20">&nbsp; &nbsp;</td>
                                                ...
                                                <tr>
                                                    <td class="auto-style19" colspan="2">
                                                        <asp:Button ID="btnCrearCondominioGuardar" runat="server" OnClick="btnCrearCondominioGuardar_Click" Text="Guardar" />
                                                        &nbsp;<asp:Button ID="btnCrearCondominioCancelar" runat="server" OnClick="btnCrearCondominioCancelar_Click" Text="Cancelar" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                ...
                                <tr>
                                    <td rowspan="2" style="vertical-align: top; padding-left:10px; padding-top:10px;" class="loginDataTable">
                                        <asp:Panel ID="panelDeptos" runat="server" HorizontalAlign="Left" Visible="False" Width="238px" Wrap="False">
                                            <table class="auto-style1">
                                                <tr>
                                                    <td colspan="2">
                                                        <h2>Departamentos</h2>
                                                ...
                                                <tr>
                                                    <td class="auto-style22">Agregar:
                                                        <asp:TextBox ID="txtAgregarDepto" runat="server" Width="50px"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnAgregarDeptoAgregar" runat="server" Height="30px" OnClick="btnAgregarDeptoAgregar_Click" Text="Agregar" Width="85px" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style22">&nbsp; &nbsp;</td>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="gridview" HorizontalAlign="Left" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" Width="100%">
                                                            <Columns>
                                                                ...
                                                                <asp:CommandField HeaderText="Acciones" SelectText="Seleccionar" ShowCancelButton="False" ShowSelectButton="True" />
                                                            </Columns>
                                                            <EmptyDataTemplate>
                                                                No existen departamentos creados para este condominio.
                                                            </EmptyDataTemplate>
                                                        </asp:GridView>
                                                    </td>
                                                </tr>
